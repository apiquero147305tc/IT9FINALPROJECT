    ...
    <section class="min-h-screen bg-slate-50 py-12 px-6 lg:px-12">
                ...
                <div class="lg:col-span-8 space-y-4">
                    ...
                    @foreach($cartItems as $item)
                        <div class="bg-white border border-slate-200 rounded-3xl p-6 flex items-center gap-6 shadow-sm">
                            ...
                            <div class="flex-1">
                                <h3 class="text-xl font-black uppercase">{{ $item->product->name }}</h3>
                ...
                <div class="lg:col-span-4">
                    <div class="bg-slate-900 rounded-[2rem] p-8 text-white sticky top-24">
                        ...
                        <div class="flex justify-between items-end mb-6">
                            <span class="text-orange-500 text-xs">Total</span>
                        ...
                        <form action="{{ route('cart.checkout') }}" method="POST">
                            @csrf
                            <button class="w-full bg-orange-600 py-4 rounded-2xl font-black uppercase">
                                🚀 Checkout
                            </button>
                        </form>
        ...
        @else
            ...
            <div class="text-center py-32 bg-white rounded-3xl">
                ...
                <a href="{{ route('buyer.home') }}" class="mt-10 inline-block bg-slate-900 text-white px-10 py-4 rounded-2xl">
                    Start Shopping
                </a>
            </div>
