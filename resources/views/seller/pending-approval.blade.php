...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <!-- ✅ FIX: Removed self-approve button. Only admin can approve. -->

            <!-- Delete Account Option -->
            <div class="delete-section">
                <p>Changed your mind?</p>
                <form action="{{ route('seller.confirm.no') }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete your account? This cannot be undone.');">
                    @csrf
                    @method('DELETE')
