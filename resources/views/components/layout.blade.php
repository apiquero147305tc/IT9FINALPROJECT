...
<head>
    ...
    <style>
        ...
        ::-webkit-scrollbar-thumb { background: #dc2626; border-radius: 10px; } /* Red-Orange Scrollbar */
    </style>
</head>
<body class="text-slate-900 antialiased overflow-x-hidden">

<!-- RED-ORANGE NAVIGATION BAR -->
    ...
    <div class="max-w-[1440px] mx-auto px-6 lg:px-12 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-10">
            <a href="{{ route('home') }}" class="group flex items-center gap-3 no-underline">
                ...
                <div class="flex flex-col leading-none">
                    ...
                    <span class="text-[9px] font-bold text-red-100 uppercase tracking-[0.3em] opacity-80">Studio Hub</span>
                </div>
            </a>
            ...
            <ul class="hidden lg:flex items-center gap-8 list-none mb-0 p-0">
                ...
                <li><a href="{{ route('bestSeller') }}" class="text-[10px] font-black uppercase tracking-[0.2em] text-red-50/80 hover:text-white transition-all no-underline">Best Sellers</a></li>
                <li><a href="{{ route('about') }}" class="text-[10px] font-black uppercase tracking-[0.2em] text-red-50/80 hover:text-white transition-all no-underline">About</a></li>
                <li><a href="{{ route('contact') }}" class="text-[10px] font-black uppercase tracking-[0.2em] text-red-50/80 hover:text-white transition-all no-underline">Contact</a></li>
            </ul>
        </div>
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="flex items-center gap-4">
                @auth
                    <!-- CART -->
                    <a href="{{ route('cart.index') }}" class="text-white hover:text-red-200 transition-all relative p-2">
                    ...
                    <div class="flex items-center gap-3 bg-white/10 p-1.5 pr-4 rounded-2xl border border-white/10 group transition-all">
                        ...
                        <div class="flex flex-col">
                            ...
                            <form action="{{ route('logout') }}" method="POST" class="m-0 p-0">
                                @csrf
                                <button type="submit" class="text-red-200 hover:text-white text-[8px] font-black uppercase tracking-tighter transition-colors block text-left">
                                    [Logout]
                                </button>
                            </form>
                        </div>
...
<footer class="bg-slate-950 pt-32 pb-12 text-white relative overflow-hidden">
    ...
    <div class="absolute top-0 right-0 opacity-5 pointer-events-none select-none">
        <h1 class="text-[22rem] font-black leading-none translate-x-1/3 -translate-y-1/4 italic uppercase text-red-600">Crave</h1>
    </div>

    <div class="max-w-[1440px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 relative z-10">
        <div class="lg:col-span-5 space-y-8">
            <div class="flex items-center gap-4">
                <div class="bg-red-600 p-3 rounded-2xl shadow-xl shadow-red-900/20">
                    <span class="text-2xl text-white">🛒</span>
                </div>
                <h3 class="font-black text-3xl tracking-tighter uppercase italic text-white">CraveCart<span class="text-red-600">.</span></h3>
            </div>
