<x-layout>
    <section class="min-h-screen flex items-center justify-center bg-[#FDFCFB] px-6 py-20 relative overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-[550px]">
            ...
            <div class="bg-white p-8 md:p-12 rounded-[50px] border border-slate-100 shadow-2xl shadow-slate-200/50">
                ...
                <form id="registerForm" action="{{ ($role ?? 'buyer') == 'seller' ? route('seller.register.post') : route('buyer.register.post') }}" 
                    ...
                    <div id="seller-info" class="space-y-6 pt-4 hidden">
                        <div class="bg-rose-50/50 p-6 rounded-[35px] space-y-6 border border-rose-100">
                            <div class="space-y-2">
    ...
    <script>
        function toggleRoleFields() {
            ...
            // Update form action and visibility based on role selection
            if (role === "seller") {
                sellerInfo.classList.remove('hidden');
                studentInfo.classList.add('hidden');
                registerForm.action = "{{ route('seller.register.post') }}";
            } else {
                sellerInfo.classList.add('hidden');
                studentInfo.classList.remove('hidden');
                registerForm.action = "{{ route('buyer.register.post') }}";
            }
        }
